...
final class CalendarViewController: DayViewController, EKEventEditViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let attributes5: [NSAttributedString.Key: Any] = [NSAttributedString.Key.font: UIFont(name: "HelveticaNeue-Bold", size: 35)!, NSAttributedString.Key.foregroundColor: UIColor.blue]
